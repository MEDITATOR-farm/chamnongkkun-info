...
// 카테고리별 OG 이미지 (썸네일 없을 때 기본값)
const CATEGORY_OG_IMAGE: Record<string, string> = {
  정보: `${BASE_URL}/og/og-info.png`,
  행사: `${BASE_URL}/og/og-event.png`,
  농업: `${BASE_URL}/og/og-farm.png`,
  복지: `${BASE_URL}/og/og-welfare.png`,
  지원금: `${BASE_URL}/og/og-support.png`,
  귀농: `${BASE_URL}/og/og-rural.png`,
  부동산: `${BASE_URL}/og/og-estate.png`,
};

const DEFAULT_OG_IMAGE = `${BASE_URL}/images/daebyeongdaedo_lined.webp`;
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const ogImage = postData.thumbnail
    || CATEGORY_OG_IMAGE[postData.category]
    || DEFAULT_OG_IMAGE;
