  ...
  return (
    <div className="relative">
                      ...
                      {diary.video ? (
                        ...
                        <div className="space-y-2">
                          {images.map((img, idx) => (
                            <div
                              key={idx}
                              className="rounded-[20px] overflow-hidden shadow-lg border border-primary/5 bg-primary/5 cursor-pointer active:scale-[0.98] transition-transform"
      ...
      {viewingImg && (
        ...
        >
          <button
            className="absolute top-4 right-4 z-[210] w-10 h-10 rounded-full bg-white/10 backdrop-blur-md text-white text-lg flex items-center justify-center"
            onClick={() => setViewingImg(null)}
          >✕</button>
          <img
            src={viewingImg}
